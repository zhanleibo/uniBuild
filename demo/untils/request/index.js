...
import $uni from '@/common/js/util.js'

// 判断在哪个开发环境中
const baseUrl = process.env.NODE_ENV === 'development' ? "开发环境" : "生产环境"
...
const reqInterceptor = async (options) => {
	options.header = {  // 头部塞入token 进行验证
		...options.header,
		'vueUiToken': store.state.userInfo.token,
	}
